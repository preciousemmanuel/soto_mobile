...
class VendorOrderCancelledTab extends StatefulWidget {
  const VendorOrderCancelledTab({
    super.key,
    required this.vm,
  });
  ...
  @override
  State<VendorOrderCancelledTab> createState() =>
      _VendorOrderCancelledTabState();
}

class _VendorOrderCancelledTabState extends State<VendorOrderCancelledTab> {
  @override
  void initState() {
    super.initState();
    printty('init state');
